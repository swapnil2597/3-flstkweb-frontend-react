...
class Contact extends Component {
 ...
 validate(firstname, lastname, telnum, email) {
  ...
  const reg = /^\d+$/;
  if (this.state.touched.telnum && !reg.test(telnum)) errors.telnum = "your telephone number should only contain numerical characters";
    ...
    <div className="row row-content">
     ...
     <div className="col-12 col-sm-11 offset-sm-1">
      <div className="btn-group" role="group">
       ...
       <a role="button" className="btn btn-info" href="./redirect">
